"""Deprecated re-export shim — module moved to :mod:`papertrade_india.domain.rules.risk`.
...
_warnings.warn(
    "papertrade_india.risk is deprecated; "
    "import from papertrade_india.domain.rules.risk instead.",
    DeprecationWarning,
    stacklevel=2,
)

import papertrade_india.domain.rules.risk as _src  # noqa: E402
from papertrade_india.domain.rules.risk import *  # noqa: E402, F401, F403

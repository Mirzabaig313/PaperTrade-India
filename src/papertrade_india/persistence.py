"""Deprecated re-export shim — module moved to :mod:`papertrade_india.infrastructure.persistence`.
...
_warnings.warn(
    "papertrade_india.persistence is deprecated; "
    "import from papertrade_india.infrastructure.persistence instead.",
    DeprecationWarning,
    stacklevel=2,
)

import papertrade_india.infrastructure.persistence as _src  # noqa: E402
from papertrade_india.infrastructure.persistence import *  # noqa: E402, F401, F403

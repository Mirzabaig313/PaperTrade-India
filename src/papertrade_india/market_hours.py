"""Deprecated re-export shim — module moved to :mod:`papertrade_india.infrastructure.market_hours`.
...
_warnings.warn(
    "papertrade_india.market_hours is deprecated; "
    "import from papertrade_india.infrastructure.market_hours instead.",
    DeprecationWarning,
    stacklevel=2,
)

from papertrade_india.infrastructure.market_hours import *  # noqa: E402, F401, F403
import papertrade_india.infrastructure.market_hours as _src  # noqa: E402

"""Deprecated re-export shim — module moved to :mod:`papertrade_india.infrastructure.ledger`.
...
_warnings.warn(
    "papertrade_india.ledger is deprecated; "
    "import from papertrade_india.infrastructure.ledger instead.",
    DeprecationWarning,
    stacklevel=2,
)

import papertrade_india.infrastructure.ledger as _src  # noqa: E402
from papertrade_india.infrastructure.ledger import *  # noqa: E402, F401, F403

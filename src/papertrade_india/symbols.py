"""Deprecated re-export shim — module moved to :mod:`papertrade_india.infrastructure.symbols`.
...
_warnings.warn(
    "papertrade_india.symbols is deprecated; "
    "import from papertrade_india.infrastructure.symbols instead.",
    DeprecationWarning,
    stacklevel=2,
)

import papertrade_india.infrastructure.symbols as _src  # noqa: E402
from papertrade_india.infrastructure.symbols import *  # noqa: E402, F401, F403

"""Deprecated re-export shim — module moved to :mod:`papertrade_india.execution.settlement`.
...
_warnings.warn(
    "papertrade_india.settlement is deprecated; "
    "import from papertrade_india.execution.settlement instead.",
    DeprecationWarning,
    stacklevel=2,
)

from papertrade_india.execution.settlement import *  # noqa: E402, F401, F403
import papertrade_india.execution.settlement as _src  # noqa: E402

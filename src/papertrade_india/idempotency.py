"""Deprecated re-export shim — module moved to :mod:`papertrade_india.infrastructure.idempotency`.
...
_warnings.warn(
    "papertrade_india.idempotency is deprecated; "
    "import from papertrade_india.infrastructure.idempotency instead.",
    DeprecationWarning,
    stacklevel=2,
)

from papertrade_india.infrastructure.idempotency import *  # noqa: E402, F401, F403
import papertrade_india.infrastructure.idempotency as _src  # noqa: E402

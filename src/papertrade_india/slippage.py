"""Deprecated re-export shim — module moved to :mod:`papertrade_india.execution.slippage`.
...
_warnings.warn(
    "papertrade_india.slippage is deprecated; "
    "import from papertrade_india.execution.slippage instead.",
    DeprecationWarning,
    stacklevel=2,
)

from papertrade_india.execution.slippage import *  # noqa: E402, F401, F403
import papertrade_india.execution.slippage as _src  # noqa: E402

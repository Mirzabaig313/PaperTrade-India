"""Deprecated re-export shim — module moved to :mod:`papertrade_india.domain.exceptions`.
...
_warnings.warn(
    "papertrade_india.exceptions is deprecated; "
    "import from papertrade_india.domain.exceptions instead.",
    DeprecationWarning,
    stacklevel=2,
)

import papertrade_india.domain.exceptions as _src  # noqa: E402
from papertrade_india.domain.exceptions import *  # noqa: E402, F401, F403

"""Deprecated re-export shim — module moved to :mod:`papertrade_india.infrastructure.clock`.
...
_warnings.warn(
    "papertrade_india.clock is deprecated; "
    "import from papertrade_india.infrastructure.clock instead.",
    DeprecationWarning,
    stacklevel=2,
)

import papertrade_india.infrastructure.clock as _src  # noqa: E402
from papertrade_india.infrastructure.clock import *  # noqa: E402, F401, F403

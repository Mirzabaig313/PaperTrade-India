"""Deprecated re-export shim — module moved to :mod:`papertrade_india.infrastructure.migrations`.
...
_warnings.warn(
    "papertrade_india.migrations is deprecated; "
    "import from papertrade_india.infrastructure.migrations instead.",
    DeprecationWarning,
    stacklevel=2,
)

import papertrade_india.infrastructure.migrations as _src  # noqa: E402
from papertrade_india.infrastructure.migrations import *  # noqa: E402, F401, F403

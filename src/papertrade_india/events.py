"""Deprecated re-export shim — module moved to :mod:`papertrade_india.infrastructure.events`.
...
_warnings.warn(
    "papertrade_india.events is deprecated; "
    "import from papertrade_india.infrastructure.events instead.",
    DeprecationWarning,
    stacklevel=2,
)

from papertrade_india.infrastructure.events import *  # noqa: E402, F401, F403
import papertrade_india.infrastructure.events as _src  # noqa: E402

"""Deprecated re-export shim — module moved to :mod:`papertrade_india.execution.fees`.
...
_warnings.warn(
    "papertrade_india.fees is deprecated; "
    "import from papertrade_india.execution.fees instead.",
    DeprecationWarning,
    stacklevel=2,
)

import papertrade_india.execution.fees as _src  # noqa: E402
from papertrade_india.execution.fees import *  # noqa: E402, F401, F403

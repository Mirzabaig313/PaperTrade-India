"""Deprecated re-export shim — module moved to :mod:`papertrade_india.orders.preopen`.
...
_warnings.warn(
    "papertrade_india.preopen is deprecated; "
    "import from papertrade_india.orders.preopen instead.",
    DeprecationWarning,
    stacklevel=2,
)

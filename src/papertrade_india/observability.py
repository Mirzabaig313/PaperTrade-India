"""Deprecated re-export shim — module moved to :mod:`papertrade_india.infrastructure.observability`.
...
_warnings.warn(
    "papertrade_india.observability is deprecated; "
    "import from papertrade_india.infrastructure.observability instead.",
    DeprecationWarning,
    stacklevel=2,
)

from papertrade_india.infrastructure.observability import *  # noqa: E402, F401, F403
import papertrade_india.infrastructure.observability as _src  # noqa: E402

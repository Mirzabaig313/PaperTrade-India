"""Deprecated re-export shim — module moved to :mod:`papertrade_india.workers.limit_orders`.
...
_warnings.warn(
    "papertrade_india.limit_orders is deprecated; "
    "import from papertrade_india.workers.limit_orders instead.",
    DeprecationWarning,
    stacklevel=2,
)

from papertrade_india.workers.limit_orders import *  # noqa: E402, F401, F403
import papertrade_india.workers.limit_orders as _src  # noqa: E402
